...
/**
 * Marketing Page (SaaS) - Displays marketing-related cards like Strategy and Campaigns.
 * Part of the 'Marketing' department within a SaaS business.
 */
    ...
    <div className="min-h-screen bg-[#f3f2ed]">
      ...
      <div className="flex items-center gap-2 px-6 pt-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="font-bold text-xl ml-24 text-gray-900">Marketing</div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center gap-8 mb-8">
        {["Home", "Team"].map((tab) => (
          ...
          >
            ...
            {activeTab === tab && (
              <motion.div
                layoutId="activeTabMarketingSaaS"
