...
const Phase = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-200px)] bg-[#f0f0eb] px-4 sm:px-8 relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center w-full overflow-y-auto no-scrollbar pb-20">
        <DragDropContext onDragEnd={onDragEnd}>
          <Droppable droppableId="bizinfra-phase-cards" direction="horizontal">
            {(provided) => (
              <div
