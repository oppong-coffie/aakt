        ...
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="px-8 -mt-20 text-center relative z-10">
              <div className="inline-block p-1.5 bg-white rounded-[2rem] shadow-2xl">
                <img
                  src={selectedPerson.avatar}
                  className="w-36 h-36 rounded-[1.7rem] bg-gray-50 object-cover"
              ...
              <div className="mt-4 mb-6">
                ...
                <span className="inline-flex items-center px-3 py-1 rounded-full bg-blue-50 text-blue-600 text-[10px] font-bold uppercase tracking-wider">
                  {selectedPerson.role}
                </span>
              </div>
    ...
    <div className="flex flex-col h-full bg-[#f0f0eb] px-4 sm:px-8 relative overflow-hidden">
        ...
        <div className="flex items-center gap-2 relative">
          ...
          <div className="relative">
            <motion.button
              ...
              className={`w-10 h-10 rounded-xl flex items-center justify-center transition-colors ${isPlusDropdownOpen ? "bg-blue-600 text-white shadow-lg shadow-blue-600/30" : "text-gray-400 hover:text-blue-600 hover:bg-white"}`}
            >
              <PlusIcon />
            </motion.button>
              ...
              {isPlusDropdownOpen && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute right-0 top-12 w-64 bg-white rounded-2xl shadow-xl border border-gray-100 z-50 overflow-hidden py-2"
                  >
                    <button
                      onClick={() => {
                      ...
                      className="w-full text-left px-5 py-3 text-sm font-bold text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors flex items-center gap-3"
                    >
                      Contact
                    </button>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-20 relative">
        ...
        {viewMode === "people" ? (
          ...
          <div className="w-full h-[500px] rounded-4xl relative overflow-hidden bg-white border border-gray-100 mb-8">
